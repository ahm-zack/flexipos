...
import { useAppetizers } from "../hooks/use-appetizers";

export function AppetizerCashierView() {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground text-center mb-6">
            Discover our delicious appetizer selection
          </p>
          {/* Search Bar */}
        ...
        {/* Appetizer Grid - Cashier View (No management actions) */}
        {isLoading ? (
