...
export function CreateMiniPieForm({
  open,
  onOpenChange,
  ...
  const createMiniPieMutation = useCreateMiniPie();
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new mini pie to your menu. Fill in all the details below.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 gap-4">
            ...
            {/* Image Upload */}
            <div className="space-y-2">
              <Label htmlFor="imageFile">Mini Pie Image (Optional)</Label>
          ...
          <DialogFooter>
            ...
            <Button
              type="submit"
              disabled={createMiniPieMutation.isPending || isUploading}
            >
              {isUploading
                ? "Uploading..."
                : createMiniPieMutation.isPending
                ? "Creating..."
                : "Create Mini Pie"}
            </Button>
          </DialogFooter>
