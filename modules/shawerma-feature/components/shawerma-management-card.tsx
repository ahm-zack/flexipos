...
interface ShawermaManagementCardProps {
  shawarma: Shawarma;
  onEdit?: (shawarma: Shawarma) => void;
  onDelete?: (shawarma: Shawarma) => void;
}

export function ShawermaManagementCard({
  shawarma,
  onEdit,
  onDelete,
}: ShawermaManagementCardProps) {
        ...
        <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48">
              {onEdit && (
                <DropdownMenuItem onClick={() => onEdit(shawarma)}>
