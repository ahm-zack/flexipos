  ...
  public: {
    Tables: {
      business_order_counters: {
        ...
        Relationships: [
          {
            foreignKeyName: "business_order_counters_business_id_businesses_id_fk"
            columns: ["business_id"]
            isOneToOne: true
      ...
      sales_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "sales_reports_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "businesses"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "sales_reports_generated_by_fkey"
            columns: ["generated_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
